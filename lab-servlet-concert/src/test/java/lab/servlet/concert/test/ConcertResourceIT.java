package lab.servlet.concert.test;
...
import lab.servlet.concert.common.Config;
import lab.servlet.concert.domain.Concert;
import lab.servlet.concert.services.SerializationMessageBodyReaderAndWriter;
...
public class ConcertResourceIT {
    ...
    public void clearAndPopulate() {
        ...
        for (Concert concert : concerts) {
            ...
            addCookieToInvocation(builder);
            try (Response response = builder.post(Entity.entity(concert, "application/java-serialization"))) {
                processCookieFromResponse(response);
